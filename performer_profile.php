...
<?php
	include("connection.php");
		if(isset($_POST["submit"]))
		{
			...
			$sel = "INSERT INTO `performer` (`fname`, `lname`, `stage`, `email`, `contact`, `dob`)
			VALUES ( '$fname', '$lname', '$stage', '$email', '$contact', '$dob')";
			$sell = mysqli_query($con,$sel);
			if($sell ==1)
			{
				header("Location:performer_profilee.php");
			}
			else
			{
				echo "failed";
      ...
      <div class="container">
        ...
        <div class="row justify-content-center">
          <div class="col-lg-6 mb-5">
            <form method="POST" action="performer_profile.php">
