...
<?php
		if(isset($_POST["submit"]))
		{
			$name=$_POST["name"];
			$_SESSION["name"]=$name;
			header("Location:organiser_profile_paid.php");
		}
?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-lg-5 text-center">
            <h2 class="text-white mb-4"> Organiser Profile</h2>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        ...
        <div class="row justify-content-center">
          <div class="col-lg-6 mb-5">
            <form  method="POST" action="organiser_profilee.php">
			
						
			  <label class="control-label " for="email">Gender</label>
              <div class="form-group row">
                <div class="col-md-12">
                  <select type="text" class="form-control" placeholder="Stage Name / AKA" name="email">
				  <option>Male</option>
			...
			<label class="control-label " for="email">Address line 1</label>
              <div class="form-group row">
                <div class="col-md-12">
                  <input type="text" class="form-control" placeholder="Address line 1" name="email">
                </div>
              </div>
...
<label class="control-label " for="email">State</label>
			  <div class="form-group row">
                <div class="col-md-12">
                  <input type="text" class="form-control" placeholder="State"name="contact">
                </div>
              </div>
			  <label class="control-label " for="email">Pincode</label>
			  <div class="form-group row">
                <div class="col-md-12">
                  <input type="number" class="form-control" placeholder="Pincode"name="contact">
                </div>
              </div>
