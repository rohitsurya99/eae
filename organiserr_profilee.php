...
if(isset($_POST["submit"]))
{
	...
	$sel = "UPDATE `organiser` SET `gender`='$gender',`address`='$address',`country`='$country',
	`state`='$state',`pincode`='pincode' WHERE `email`='$email' AND `contact`='$contact'";
	$sell = mysqli_query($con,$sel);
	if ($sell==1)
	{
		header("Location:organiserr_profile_paid.php");
	}
	else
	{
		echo "failed";
      ...
      <div class="container">
        ...
        <div class="row justify-content-center">
          <div class="col-lg-6 mb-5">
            <form  method="POST" action="organiserr_profilee.php">
