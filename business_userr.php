...
<?php include("header1.php")?>
	...
	<?php
		if(isset($_POST["submit"]))
		{
			...
			if($name=="Performer")
			{
			header("Location:performerr.php");
			}
			if($name=="Provider")
			{
			header("Location:providerr.php");
			}
			if($name=="Organiser")
			{
			header("Location:organiserr_profile.php");
			}
			if($name=="Sponser")
			{
			header("Location:sponserr_profile.php");
			}
			if($name=="Night Club")
			{
			header("Location:nightclub_profile.php");
			}
			if($name=="Pub")
			{
			header("Location:pub_profile.php");
			}
		}
	?>
      ...
      <div class="container">
        ...
        <div class="row justify-content-center">
          <div class="col-lg-6 mb-5">
            <form action="#" method="POST" action="business_user.php">
