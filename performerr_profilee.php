...
if(isset($_POST["submit"]))
{
	...
	$sel = "UPDATE `Performer` SET `gender`='$gender',`address`='$address',`country`='$country',
	`state`='$state',`pincode`='pincode' WHERE `email`='$email' AND `contact`='$contact'";
	$sell = mysqli_query($con,$sel);
	if ($sell==1)
	{
		header("Location:performerr_profile_paid.php");
	}
	else
	{
		echo "failed";
      ...
      <div class="container">
        ...
        <div class="row justify-content-center">
          <div class="col-lg-6 mb-5">
            <form  method="POST" action="performerr_profilee.php">
			
						
			  <label class="control-label " for="email">Gender</label>
              <div class="form-group row">
                <div class="col-md-12">
                  <select type="text" class="form-control" placeholder="Stage Name / AKA" name="gender">
				  <option>Male</option>
			...
			<label class="control-label " for="email">Address line 1</label>
              ...
              <div class="form-group row">
                <div class="col-md-12">
                  <select type="text" class="form-control" placeholder="Stage Name / AKA" name="country">
