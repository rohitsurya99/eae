...
<?php
			...
			
		{
			...
			$sel = "INSERT INTO `club` (`fname`, `lname`, `club`, `email`, `contact`, `dob`, `password`)
			VALUES ('$fname', '$lname', '$club', '$email', '$contact', '$dob', '$password')";
			$sell = mysqli_query($con,$sel);
			if($sell==1)
			{
				header("Location:nightclub_profilee.php");
			}
			else
			{
				echo "failed";
      ...
      <div class="container">
        ...
        <div class="row justify-content-center">
          <div class="col-lg-6 mb-5">
            <form method="POST" action="nightclub_profile.php">
			  ...
			  <label class="control-label " for="email">Club Name</label>
              <div class="form-group row">
                <div class="col-md-12">
                  <input type="text" class="form-control" placeholder="Club name" name="club">
                </div>
              </div>
