...
<?php
		if(isset($_POST["submit"]))
		{
			$name=$_POST["name"];
			$_SESSION["name"]=$name;
			header("Location:organiser_profilee.php");
		}
?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="container">
        ...
        <div class="row justify-content-center">
          <div class="col-lg-6 mb-5">
            <form action="#" method="POST" action="performer_profile.php">
              ...
              <div class="form-group row">
                <div class="col-md-12">
                  <input type="text" class="form-control" placeholder="Buissness name" name="email">
                </div>
              </div>
