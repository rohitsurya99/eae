...
<?php
	...
	include("connection.php");
			...
			$sel = "INSERT INTO `performer` (`performer`, `fname`, `lname`, `email`, `contact`, `dob`, `password`) 
			VALUES ('$performer', '$fname', '$lname', '$email', '$contact', '$dob', '$password')";
			$sell = mysqli_query($con,$sel);
			if($sell==1)
			{
				header("Location:performerr_profilee.php");
			}
			else
			{
				echo "failed";
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 text-center mb-5">
            <h2 class="text-black section-title text-uppercase">Profile - <?php echo $_SESSION["name"];?></h2>
          </div>
        </div>
        <div class="row justify-content-center">
          <div class="col-lg-6 mb-5">
            <form method="POST" action="performerr_profile.php">
