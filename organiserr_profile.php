...
<?php
			...
			
		{
			...
			$sel = "INSERT INTO `organiser` (`fname`, `lname`, `bname`, `email`, `contact`, `dob`, `password`)
			VALUES ('$fname', '$lname', '$bname', '$email', '$contact', '$dob', '$password')";
			$sell = mysqli_query($con,$sel);
			if($sell==1)
			{
				header("Location:organiserr_profilee.php");
			}
			else
			{
				echo "failed";
      ...
      <div class="container">
        ...
        <div class="row justify-content-center">
          <div class="col-lg-6 mb-5">
            <form method="POST" action="organiserr_profile.php">
			  ...
			  <label class="control-label " for="email">Buisness Name</label>
              <div class="form-group row">
                <div class="col-md-12">
                  <input type="text" class="form-control" placeholder="Buisness Name" name="bname">
                </div>
              </div>
