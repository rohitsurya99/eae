...
<?php
		if(isset($_POST["submit"]))
		{
			$name=$_POST["name"];
			$_SESSION["name"]=$name;
			header("Location:provider_profilee.php");
		}
?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="container">
        ...
        <div class="row justify-content-center">
          <div class="col-lg-6 mb-5">
            <form action="#" method="POST" action="provider_profile.php">
              ...
              <div class="form-group row">
                <div class="col-md-12">
                  <input type="text" class="form-control" placeholder="Stage Name / AKA" name="email">
                </div>
              </div>
